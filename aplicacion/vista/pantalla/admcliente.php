    ...
    <body>
        ...
        <div id="cabBotones">
            <ul class="nav nav-tabs" style="height: auto;">
                <li><a title="Agregar Cliente" href="javascript:addCliente();" ><img src="../vista/img/agregar.png" /></a></li>
                <!--<li><a title="Edita Cliente" href="javascript:editClienteDesdeMenu('chkHijoRol');"><img src="../vista/img/edit.png" /></a></li>
                <li><a title="Eliminar Cliente" href="javascript:delClienteDesdeMenu('chkHijoRol');"><img src="../vista/img/trash.png" /></a></li>-->
            </ul>
        </div>
        <div id="divTabla" ></div>
