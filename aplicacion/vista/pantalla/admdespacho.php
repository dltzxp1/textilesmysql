...
<html>
    ...
    <script>
        window.onload=consDespacho('0');
    </script>
    <body>

        <div class="solobordeIng" align="center">
            Adminsitración de Despacho
        </div>                   
        <div id="cabBotones">
            <ul class="nav nav-tabs" style="height: auto;">
                <li><a title="Agregar Despacho" href="javascript:addDespacho();" ><img src="../vista/img/agregar.png" /></a></li>
                
                <li class="dropdown"><a href="../vista/pantalla/img/admdespacho.php">Despacho</a></li>
                
                <li><a title="Edita Despacho" href="javascript:editDespachoDesdeMenu('chkHijoRol');"><img src="../vista/img/edit.png" /></a></li>
                <li><a title="Eliminar Despacho" href="javascript:delDespachoDesdeMenu('chkHijoRol');"><img src="../vista/img/trash.png" /></a></li>
            </ul>
        </div>
        <div id="divTabla" ></div>
