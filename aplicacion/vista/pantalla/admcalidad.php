...
<html>
    ...
    <script>
        window.onload=consCalidad('0');
    </script>
    <body>

        <div class="solobordeIng" align="center">
            Adminsitración de Calidad
        </div>

        <div id="cabBotones">
            <ul class="nav nav-tabs" style="height: auto;">
                <li><a title="Agregar Persona" href="javascript:addCalidad();" ><img src="../vista/img/agregar.png" /></a></li>
