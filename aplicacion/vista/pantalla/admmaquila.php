...
<html>
    ...
    <script>
        window.onload=consMaquila('0');
    </script>
    <body>

        <div class="solobordeIng" align="center">
            Adminsitración de Maquila
        </div>

        <div id="cabBotones">
            <ul class="nav nav-tabs" style="height: auto;">
                <li><a title="Agregar Maquila" href="javascript:addMaquila();" ><img src="../vista/img/agregar.png" /></a></li>
                <!--<li><a title="Edita Maquila" href="javascript:editMaquilaDesdeMenu('chkHijoRol');"><img src="../vista/img/edit.png" /></a></li>
                <li><a title="Eliminar Maquila" href="javascript:delMaquilaDesdeMenu('chkHijoRol');"><img src="../vista/img/trash.png" /></a></li>-->
            </ul>
        </div>
        <div id="divTabla" ></div>
