...
<html>
    ...
    <script>
        window.onload=consCortador('0');
    </script>
    <body>

        <div class="solobordeIng" align="center">
            Adminsitración de Cortador
        </div>

        <div id="cabBotones">
            <ul class="nav nav-tabs" style="height: auto;">
                <li><a title="Agregar Cortador" href="javascript:addCortador();" ><img src="../vista/img/agregar.png" /></a></li>
