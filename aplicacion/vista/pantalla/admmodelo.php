...
<html>
    ...
    <script>
        window.onload=consModelo('0');
    </script>
    <body>

        <div class="solobordeIng" align="center">
            Adminsitración de Modelos
        </div>

        <div id="cabBotones">
            <ul class="nav nav-tabs" style="height: auto;">
                <li><a title="Agregar Modelo" href="javascript:addModelo();" ><img src="../vista/img/agregar.png" /></a></li>
                <!--<li><a title="Edita Modelo" href="javascript:editModeloDesdeMenu('chkHijoRol');"><img src="../vista/img/edit.png" /></a></li>
                <li><a title="Eliminar Modelo" href="javascript:delModeloDesdeMenu('chkHijoRol');"><img src="../vista/img/trash.png" /></a></li>-->
            </ul>
        </div>
        <div id="divTabla" ></div>
