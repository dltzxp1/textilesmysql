                    ...
                    <div class="btn-group" style="border-bottom: transparent solid 7px;">
                        ...
                        <ul class="dropdown-menu"  style="left: 10%;">
                            ...
                            for ($r = 0; $r < count($arrUsuario); $r++) {
                                echo "<li> <a href=\"javascript:selectUsuarioRol_pantalla('" . $arrUsuario[$r]->us_id . "','" . $arrUsuario[$r]->us_nombre . "');asignarUsuario('" .  utf8_encode($arrUsuario[$r]->us_nombre) . "');\">" . utf8_encode($arrUsuario[$r]->us_nombre) . "</a></li>";
                            }
                            ?>
                        </ul>
                    </div>
