...
<html>
    ...
    <script>
        window.onload=consDisenio('0');
    </script>
    <body>

        <div class="solobordeIng" align="center">
            Adminsitración de diseño
        </div>

        <div id="cabBotones">
            <ul class="nav nav-tabs" style="height: auto;">
                <li><a title="Agregar Persona" href="javascript:addDisenio();" ><img src="../vista/img/agregar.png" /></a></li>
