...
<html>
    ...
    <script>
        window.onload=consTela('0');
    </script>
    <body>

        <div class="solobordeIng" align="center">
            Adminsitración de Telas
        </div>

        <div id="cabBotones">
            <ul class="nav nav-tabs" style="height: auto;">
                <li><a title="Agregar Telas" href="javascript:addTela();" ><img src="../vista/img/agregar.png" /></a></li>
                <!--<li><a title="Edita Telas" href="javascript:editTelaDesdeMenu('chkHijoRol');"><img src="../vista/img/edit.png" /></a></li>
                <li><a title="Eliminar Telas" href="javascript:delTelaDesdeMenu('chkHijoRol');"><img src="../vista/img/trash.png" /></a></li>-->
            </ul>
        </div>
        <div id="divTabla" ></div>
