    ...
    <body>
        ...
        <div id="cabBotones">
            <ul class="nav nav-tabs" style="height: auto;margin-left: 0%;">
                ...
                <li><a title="Eliminar Foto" href="javascript:delFotoDesdeMenu('chkHijoRol');"><img src="../vista/img/trash.png" /></a></li>
                <li>
                ...
                <li>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <div class="btn-group" style="border-bottom: transparent solid 7px;">
                        <button class="btn" id="pr_nombre" style="width: 150px;">Seleccione Articulo </button>
                        <button class="btn dropdown-toggle" data-toggle="dropdown">
                            <span class="caret"></span>
                        </button>
