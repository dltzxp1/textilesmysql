...
<html>
    ...
    <script>
        window.onload=consEmpaque('0');
    </script>
    <body>
        <div class="solobordeIng" align="center">
            Adminsitración de Empaque
        </div>
        <div id="cabBotones">
            <ul class="nav nav-tabs" style="height: auto;">
                <li><a title="Agregar Persona" href="javascript:addEmpaque();" ><img src="../vista/img/agregar.png" /></a></li>
                <!--<li><a title="Edita Persona" href="javascript:editPersonaDesdeMenu('chkHijoRol');"><img src="../vista/img/edit.png" /></a></li>
                <li><a title="Eliminar Persona" href="javascript:delPersonaDesdeMenu('chkHijoRol');"><img src="../vista/img/trash.png" /></a></li>-->
            </ul>
        </div>
        <div id="divTabla" ></div>
