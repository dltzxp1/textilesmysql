...
<html>
    ...
    <script>
        window.onload=consProduccion('0');
    </script>
    <body>

        <div class="solobordeIng" align="center">
            Adminsitración de Producción
        </div>

        <div id="cabBotones">
            <ul class="nav nav-tabs" style="height: auto;">
                <li><a title="Agregar Cortador" href="javascript:addProduccion();" ><img src="../vista/img/agregar.png" /></a></li>
                <!--<li><a title="Edita Cortador" href="javascript:editCortadorDesdeMenu('chkHijoRol');"><img src="../vista/img/edit.png" /></a></li>
                <li><a title="Eliminar Cortador" href="javascript:delCortadorDesdeMenu('chkHijoRol');"><img src="../vista/img/trash.png" /></a></li>-->
            </ul>
        </div>
        <div id="divTabla" ></div>
