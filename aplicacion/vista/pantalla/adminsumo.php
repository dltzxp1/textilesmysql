...
<html>
    ...
    <script>
        window.onload=consInsumo('0');
    </script>
    <body>

        <div class="solobordeIng" align="center">
            Adminsitración de Insumos
        </div>

        <div id="cabBotones">
            <ul class="nav nav-tabs" style="height: auto;">
                <li><a title="Agregar Persona" href="javascript:addInsumo();" ><img src="../vista/img/agregar.png" /></a></li>
