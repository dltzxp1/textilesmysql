...
<html>
    ...
    <script>
        window.onload=consTalla('0');
    </script>
    <body>

        <div class="solobordeIng" align="center">
            Adminsitración de Talla
        </div>

        <div id="cabBotones">
            <ul class="nav nav-tabs" style="height: auto;">
                <li><a title="Agregar Talla" href="javascript:addTalla();" ><img src="../vista/img/agregar.png" /></a></li>
                <!--<li><a title="Edita Talla" href="javascript:editTallaDesdeMenu('chkHijoRol');"><img src="../vista/img/edit.png" /></a></li>
                <li><a title="Eliminar Talla" href="javascript:delTallaDesdeMenu('chkHijoRol');"><img src="../vista/img/trash.png" /></a></li>-->
            </ul>
        </div>
        <div id="divTabla" ></div>
