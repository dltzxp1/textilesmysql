...
<html>
    ...
    <script>
        window.onload=consArea('0');
    </script>
    <body>

        <div class="solobordeIng" align="center">
            Adminsitración de Area
        </div>

        <div id="cabBotones">
            <ul class="nav nav-tabs" style="height: auto;">
                <li><a title="Agregar Cortador" href="javascript:addArea();" ><img src="../vista/img/agregar.png" /></a></li>
