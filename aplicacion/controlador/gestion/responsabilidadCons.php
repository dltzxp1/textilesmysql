...
if ($re_id == '0') {
    ...
    if (count($arrResponsabilidad) > 0) {
        ...
        for ($r = 0; $r < count($arrResponsabilidad); $r++) {
            ...
            echo "<a title='Eliminar Responsabilidad " . $arrResponsabilidad[$r]->re_nombre . "' href='javascript:delResponsabilidad(3,\"" . $arrResponsabilidad[$r]->us_id . "\",\"" . $arrResponsabilidad[$r]->ro_id . "\",\"" . $arrResponsabilidad[$r]->re_id . "\");'><img style='width:16px;height:16px;border:0;' src='../vista/img/eliminar.png' /></a>";
            echo "<a title='Editar Responsabilidad " . $arrResponsabilidad[$r]->re_nombre . "' href='javascript:editResponsabilidad(\"" . $arrResponsabilidad[$r]->us_id . "\",\"" . $arrResponsabilidad[$r]->ro_id . "\",\"" . $arrResponsabilidad[$r]->re_id . "\",\"" . $arrResponsabilidad[$r]->re_nombre . "\",\"" . $arrResponsabilidad[$r]->re_descripcion . "\");'><img style='width:16px;height:16px;border:0;' src='../vista/img/editarx.png' /></a>";
            echo "</td>";
            echo "</tr>";
        }
        echo "</tbody> </table>";
